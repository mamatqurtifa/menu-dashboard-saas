...
function getClassColor($class) {
    if (strpos($class, 'X') !== false) {
        return 'bg-google-blue/10 text-google-blue';     } elseif (strpos($class, 'XI') !== false) {
        return 'bg-google-green/10 text-google-green';     } elseif (strpos($class, 'XII') !== false) {
        return 'bg-google-yellow/10 text-google-yellow';     } else {
...
<div class="max-w-7xl mx-auto">
    ...
    <div id="formContainer" class="mb-6 bg-white rounded-lg google-shadow p-6 <?php echo empty($siswa['id']) ? 'hidden' : ''; ?>">
        <div class="flex items-center border-b pb-4 mb-6">
            ...
            <h3 class="text-lg font-semibold"><?php echo !empty($siswa['id']) ? 'Edit Data Siswa' : 'Tambah Data Siswa'; ?></h3>
        </div>
            ...
            <div class="mt-6">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <textarea id="alamat" name="alamat" rows="3"
                        class="focus:ring-google-green focus:border-google-green block w-full pl-10 py-3 border-gray-300 rounded-md"><?php echo $siswa['alamat']; ?></textarea>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg google-shadow p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    ?>
                    <div class="text-2xl font-bold"><?php echo $male_count; ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg google-shadow p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    ?>
                    <div class="text-2xl font-bold"><?php echo $female_count; ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg google-shadow p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    ?>
                    <div class="text-2xl font-bold"><?php echo $class_count; ?></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="w-full md:w-1/4 p-2">
                <div class="bg-gray-50 rounded-lg p-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-gray-500 text-sm"><?php echo $data['total']; ?> siswa</span>
                    </div>
                        ...
                        <?php while ($row = $result->fetch_assoc()) { ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo $row['nis']; ?></div>
                                    <div class="text-xs text-gray-500">Tahun Masuk: <?php echo getEnrollmentYear($row['nis']); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                            <span class="text-gray-600 font-medium"><?php echo substr($row['nama'], 0, 1); ?></span>
                                        </div>
                                        <div class="ml-4">
...
function confirmDelete(id, name) {
    ...
    if (deleteModal && confirmDelete) {
        ...
        confirmDelete.href = `dashboard.php?page=menu&menu=siswa&action=delete&id=${id}`;
